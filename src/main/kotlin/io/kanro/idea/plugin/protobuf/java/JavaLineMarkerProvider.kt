...
class JavaLineMarkerProvider : RelatedItemLineMarkerProvider() {
        ...
        return CachedValuesManager.getCachedValue(sourceClazz) {
            ...
            for (it in clazz.uastSuperTypes) {
                ...
                val element =
                    ...
                    ).myFirstIsInstanceOrNull<ProtobufServiceDefinition>()
            ...
            for (it in clazz.uastSuperTypes) {
                ...
                val element =
                    StubIndex.getElements(
                        ...
                        scope,
                        ProtobufElement::class.java,
                    ).myFirstIsInstanceOrNull<ProtobufRpcDefinition>()
                if (element != null) {
    ...
    private inline fun <reified T> Iterable<*>.myFirstIsInstanceOrNull(): T? {
        for (element in this) {
            if (element is T) {
                return element
            }
