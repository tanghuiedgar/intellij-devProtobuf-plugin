...
interface ProtobufFile :
    ...
    ProtobufOptionOwner,
    ItemPresentation {
    fun messages(): Array<ProtobufMessageDefinition>

    fun imports(): Array<ProtobufImportStatement>

    fun enums(): Array<ProtobufEnumDefinition>

    fun services(): Array<ProtobufServiceDefinition>
    ...
    fun syntax(): String?
    fun syntaxStatement(): ProtobufSyntaxStatement?
