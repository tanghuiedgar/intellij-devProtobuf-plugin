...
class ProtobufFileImpl(viewProvider: FileViewProvider) : PsiFileBase(viewProvider, ProtobufLanguage), ProtobufFile {
    ...
    override fun messages(): Array<ProtobufMessageDefinition> {
        return findChildrenByClass(ProtobufMessageDefinition::class.java)
    }

    override fun enums(): Array<ProtobufEnumDefinition> {
        return findChildrenByClass(ProtobufEnumDefinition::class.java)
    }

    override fun services(): Array<ProtobufServiceDefinition> {
        return findChildrenByClass(ProtobufServiceDefinition::class.java)
    }

    override fun imports(): Array<ProtobufImportStatement> {
        return findChildrenByClass(ProtobufImportStatement::class.java)
    }
    ...
    override fun syntaxStatement(): ProtobufSyntaxStatement? {
        return this.findChild<ProtobufSyntaxStatement>()
    }
