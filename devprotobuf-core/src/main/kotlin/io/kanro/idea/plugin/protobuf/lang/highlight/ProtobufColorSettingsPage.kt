    ...
    override fun getDemoText(): String {
        return """
            ...
            service TestService {
                ...
                // [Test_Method] Doc Comment
                rpc TestMethod(TestMessageRequest) returns (TestMessageResponse) {}
            }
            """.trimIndent()
    }
    ...
    companion object {
        val DESCRIPTORS =
            arrayOf(
                ...
                AttributesDescriptor("Request", ProtobufHighlighter.REQUEST),
                AttributesDescriptor("Response", ProtobufHighlighter.RESPONSE),
            )
    }
}
